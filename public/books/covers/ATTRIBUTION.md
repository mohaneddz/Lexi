...
| Cover | Work | Commons file |
| --- | --- | --- |
| `dict-topic-animals.jpg` | *Kunstformen der Natur*, Ernst Haeckel | `Haeckel Actiniae.jpg` |
| `dict-topic-plants.jpg` | *Köhler's Medizinal-Pflanzen* | `Valeriana officinalis - Köhler–s Medizinal-Pflanzen-143 clean.jpg` |
| `dict-topic-astronomy.jpg` | *Harmonia Macrocosmica*, Andreas Cellarius, 1660 | `Cellarius Harmonia Macrocosmica - Planisphaerium Ptolemaicum.jpg` |
| `dict-topic-body.png` | *De humani corporis fabrica*, Andreas Vesalius | `Vesalius 606c.png` |
| `dict-topic-food.jpg` | *Still Life with Game, Vegetables, Fruit, and a Cockatoo* | `Still Life with Game, Vegetables, Fruit, and a Cockatoo.JPG` |
| `dict-topic-music.jpg` | Instrument plate, *Syntagma Musicum*, Michael Praetorius | `Page 16.JPG` |
